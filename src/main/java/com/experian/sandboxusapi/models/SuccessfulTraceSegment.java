...
/**
 * This is a model class for SuccessfulTraceSegment type.
 */
public class SuccessfulTraceSegment {
    private String applicantIndicator;
    private String informationSource;
    private String linkRecordKey;
    ...
    private LocationDetail toLocation;
    private InputNameDetail toName;

    /**
     * Default constructor.
     */
    public SuccessfulTraceSegment() {
    }
     ...
     * @param  linkRecordKey  String value for linkRecordKey.
     ...
     * @param  toLocation  LocationDetail value for toLocation.
     * @param  toName  InputNameDetail value for toName.
     */
    public SuccessfulTraceSegment(
            int membersCount,
            String applicantIndicator,
            String informationSource,
            String linkRecordKey,
            ...
            InputNameDetail toName) {
        this.applicantIndicator = applicantIndicator;
        this.informationSource = informationSource;
        this.linkRecordKey = linkRecordKey;
    ...
    /**
     * Getter for LinkRecordKey.
     * @return Returns the String
     */
    @JsonGetter("LinkRecordKey")
    @JsonInclude(JsonInclude.Include.NON_NULL)
    public String getLinkRecordKey() {
        return linkRecordKey;
    }

    /**
     * Setter for LinkRecordKey.
     * @param linkRecordKey Value for String
     */
    @JsonSetter("LinkRecordKey")
    public void setLinkRecordKey(String linkRecordKey) {
        this.linkRecordKey = linkRecordKey;
    }
    ...
    /**
     * Getter for ToLocation.
     * @return Returns the LocationDetail
     */
    @JsonGetter("ToLocation")
    @JsonInclude(JsonInclude.Include.NON_NULL)
    public LocationDetail getToLocation() {
        return toLocation;
    }

    /**
     * Setter for ToLocation.
     * @param toLocation Value for LocationDetail
     */
    @JsonSetter("ToLocation")
    public void setToLocation(LocationDetail toLocation) {
        this.toLocation = toLocation;
    }
    ...
    @JsonGetter("ToName")
    @JsonInclude(JsonInclude.Include.NON_NULL)
    public InputNameDetail getToName() {
        return toName;
    }

    /**
     * Setter for ToName.
     * @param toName Value for InputNameDetail
     */
    @JsonSetter("ToName")
    public void setToName(InputNameDetail toName) {
        this.toName = toName;
    }

    /**
     * Converts this SuccessfulTraceSegment into string format.
     * @return String representation of this class
     */
    @Override
    public String toString() {
        return "SuccessfulTraceSegment [" + "membersCount=" + membersCount + ", applicantIndicator="
                + applicantIndicator + ", informationSource=" + informationSource
                + ", linkRecordKey=" + linkRecordKey + ", location=" + location
                + ", locationIndicator=" + locationIndicator + ", matchDetails=" + matchDetails
                + ", members=" + members + ", name=" + name + ", nameID=" + nameID + ", searchType="
                + searchType + ", toLocation=" + toLocation + ", toName=" + toName + "]";
    }

    /**
     * Builds a new {@link SuccessfulTraceSegment.Builder} object.
     * Creates the instance with the state of the current model.
     * @return a new {@link SuccessfulTraceSegment.Builder} object
     */
    public Builder toBuilder() {
        Builder builder = new Builder(membersCount)
                ...
                .linkRecordKey(getLinkRecordKey())
    ...
    /**
     * Class to build instances of {@link SuccessfulTraceSegment}.
     */
    public static class Builder {
         ...
         * @return Builder
         */
        public Builder linkRecordKey(String linkRecordKey) {
            this.linkRecordKey = linkRecordKey;
            return this;
        }
         ...
         * @return Builder
         */
        public Builder toLocation(LocationDetail toLocation) {
            this.toLocation = toLocation;
            return this;
        }
         ...
         * @return Builder
         */
        public Builder toName(InputNameDetail toName) {
            this.toName = toName;
            return this;
        }

        /**
         * Builds a new {@link SuccessfulTraceSegment} object using the set fields.
         * @return {@link SuccessfulTraceSegment}
         */
        public SuccessfulTraceSegment build() {
            return new SuccessfulTraceSegment(membersCount, applicantIndicator, informationSource,
                    linkRecordKey, location, locationIndicator, matchDetails, members, name, nameID,
                    searchType, toLocation, toName);
        }
    }
}
